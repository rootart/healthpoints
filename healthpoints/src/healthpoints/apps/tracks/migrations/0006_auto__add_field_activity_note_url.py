...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Activity.note_url'
        db.add_column(u'tracks_activity', 'note_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Activity.note_url'
        db.delete_column(u'tracks_activity', 'note_url')
    ...
    models = {
        ...
        u'tracks.activity': {
            ...
            'note_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
